// src/pages/company/Purchases/PurchaseQuotation/AddPurchaseQuotation/AddPurchaseQuotation.jsx
...
const AddPurchaseQuotation = () => {
  ...
  return (
    <div className="purchase-document-container">
      <h2 className="document-title">Create Purchase Quotation</h2>
      ...
      <div className="action-buttons">
        ...
        <button className="save-button">Save Quotation</button>
