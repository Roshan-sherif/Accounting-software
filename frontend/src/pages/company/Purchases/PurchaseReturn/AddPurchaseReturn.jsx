// src/pages/company/Purchases/PurchaseReturn/AddPurchaseReturn/AddPurchaseReturn.jsx
...
const AddPurchaseReturn = () => {
  ...
  return (
    <div className="purchase-document-container">
      <h2 className="document-title">Create Purchase Return</h2>
      ...
      <div className="action-buttons">
        ...
        <button className="save-button">Save Return</button>
