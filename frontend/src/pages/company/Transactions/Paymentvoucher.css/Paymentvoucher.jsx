...
const PaymentVoucher = () => {
  ...
  const accountLedgers = [
    ...
    { id: 2, name: 'Rent Expense' },
    { id: 3, name: 'Utility Bills' },
    { id: 4, name: 'Salary Payments' },
    { id: 5, name: 'Professional Fees' },
    { id: 6, name: 'Travel Expense' }
  ];
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log('Payment Voucher Submitted:', voucherData);
        ...
        <div className="payment-details">
          ...
          {voucherData.paymentMode !== 'Cash' && (
            <>
              ...
              {['Cheque', 'Bank Transfer'].includes(voucherData.paymentMode) && (
                <>
                  <div className="form-group">
